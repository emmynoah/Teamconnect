...
export async function POST(req: NextRequest) {
  try {
    ...
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #374151;">
        <div style="background-color: #111827; padding: 24px 32px; border-radius: 8px 8px 0 0;">
          <h1 style="color: white; margin: 0; font-size: 18px;">Team Announcement</h1>
        ...
        <div style="background-color: #ffffff; padding: 32px; border: 1px solid #E5E7EB; border-top: none; border-radius: 0 0 8px 8px;">
          <div style="border-left: 4px solid #111827; padding-left: 16px; margin-bottom: 24px;">
    ...
    await resend.emails.send({
      ...
      to: recipients,
      subject: `Team Announcement — ${today}`,
      html,
    })
